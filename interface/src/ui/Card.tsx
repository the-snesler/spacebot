...
export const cardStyles = cva(["rounded-xl border transition-colors"], {
	variants: {
		variant: {
			default: ["border-app-line bg-app-darkBox"],
			darker: ["border-app-line bg-app-darkerBox"],
...
>(({ className, ...props }, ref) => (
	<p ref={ref} className={cx("text-sm text-ink-dull", className)} {...props} />
));
